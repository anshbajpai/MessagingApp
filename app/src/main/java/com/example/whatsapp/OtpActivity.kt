...
class OtpActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun startVerify() {
        ...
        showTimer(60000)
        progressDialog = createProgressDialog("Sending Verification Code",true)
        progressDialog.show()
    }

    private fun showTimer(milliSecondsInFuture:Long) {
        resendBtn.isEnabled = false
        mCountDownTimer = object :CountDownTimer(milliSecondsInFuture,1000){
    ...
    private fun initViews() {
        ...
        textView3.text = "Verify $phoneNumber"
        setSpannableString()
        ...
        callbacks = object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            override fun onVerificationCompleted(credential: PhoneAuthCredential) {
                ...
                Log.d("Tag","Inside On Verification Completed")
    ...
    private fun setSpannableString() {
        val span = SpannableString("${phoneNumber } Wrong Number?")
    ...
    override fun onClick(v: View?) {
        when(v){
            materialButton2 ->{
                 ...
                 val code = editText2.text.toString()
...
fun Context.createProgressDialog(message: String,isCanceable:Boolean):ProgressDialog{
    return ProgressDialog(this).apply {
        ...
        setMessage(message)
        setCanceledOnTouchOutside(isCanceable)
    }
}