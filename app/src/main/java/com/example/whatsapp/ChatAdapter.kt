...
import kotlinx.android.synthetic.main.list_itemm_chat_recv_message.view.*
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
       ...
       return when(viewType){
           TEXT_MESSAGE_RECEIVED ->{
               MessageViewHolder(inflate(R.layout.list_itemm_chat_recv_message))
           }
           TEXT_MESSAGE_SENT->{
           ...
           else -> MessageViewHolder(inflate(R.layout.list_itemm_chat_recv_message))
       }
    }
